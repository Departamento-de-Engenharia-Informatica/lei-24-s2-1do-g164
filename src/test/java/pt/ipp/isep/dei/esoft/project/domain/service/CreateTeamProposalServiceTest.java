...
class CreateTeamProposalServiceTest {
    ...
    public void setUp() {
        ...
        repo.registerCollaborator("John Doe", 123456789, "01-01-1990", "01-01-2020", "123 Main St", 987699321, job, docType,  451238965, "siii@euro.lol");
        repo.registerCollaborator("Alice Vieira", 928456689, "15-07-2006", "01-01-2020", "123 Main St", 983554321, job, docType,  451238966, "siii@euro.lol");
        repo.registerCollaborator("Ambrosio Leite", 928945689, "19-09-1999", "01-01-2020", "123 Main St", 987554321, job, docType,  451238967, "siii@euro.lol");
        repo.registerCollaborator("Elsa Freites", 988955779, "10-06-2005", "01-01-2020", "123 Main St", 987640321, job, docType, 451238968, "siii@euro.lol");
        repo.registerCollaborator("Jacinto Miguel", 789789789, "10-06-2005", "01-01-2020", "123 Main St", 987622321, job, docType,  451233968, "siii@euro.lol");
